    ...
    <Card className="w-full bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="relative">
        <div
          ...
          style={{
            backgroundImage: "url('/dummyImages/user_profile_cover_image.png')",
          }}
        ></div>
      ...
      <div className="pt-12 pb-6 px-6">
        ...
        <div className="text-center mb-6">
          ...
          <span
            style={{ backgroundColor: userTagColor(userRole as string) }}
            className={cn(
              "inline-block  text-white text-xs font-medium px-3 py-1 rounded-full"
            )}
          >
            {userRole}
          </span>
        ...
        <div className="space-y-4 border border-[#E6E6FA] p-2 rounded-md">
          ...
          <div className="space-y-3">
            <div className="flex  items-center border-b border-[#E6E6FA] py-1">
              <span className="text-gray-600 text-sm w-[200px]">First Name:</span>
              <span className="text-gray-900 font-medium">Anna</span>
            </div>

            <div className="flex  items-center border-b border-[#E6E6FA] py-1">
              <span className="text-gray-600 text-sm w-[200px]">Last Name:</span>
              <span className="text-gray-900 font-medium">Suraiya</span>
            </div>

            <div className="flex  items-center border-b border-[#E6E6FA] py-1">
              <span className="text-gray-600 text-sm w-[200px]">User Name:</span>
              <span className="text-gray-900 font-medium">Suraiya</span>
            </div>

            <div className="flex items-center border-b border-[#E6E6FA] py-1">
              <span className="text-gray-600 text-sm w-[200px]">Email:</span>
            ...
            <div className="flex  items-center border-b border-[#E6E6FA] py-1">
              <span className="text-gray-600 text-sm w-[200px]">Phone Number:</span>
